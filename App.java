...
public class App {
    ...
    public void acessaAdmin(String senha) throws Exception{
        String senha_admin = "admin";
                    ...
                    while (true){
                        ...
                        if (escolha_resumos == 1){
                            ...
                            while (true){
                                ...
                                try {
                                    escolha_resumo_itens = Input.inputInt("Selecione o tipo de ordenação do resumo.\n1 - Por quantidade\n2 - Por descrição\n3 - Sair");
                                } catch (Exception e) {
                                    System.out.println(e.getMessage());
                                }
    ...
    public void run() throws Exception{
        while (true){
            int escolha = 0;
            try {
                escolha = Input.inputInt("Bem vindo ao sistema de compras.\n1 - Acessar como administrador\n2 - Acessar como cliente\n3 - Sair");
            } catch (Exception e) {
                System.out.println(e.getMessage());
            }
            if (escolha == 1){
